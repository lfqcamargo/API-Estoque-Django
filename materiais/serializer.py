...
class GrupoSerializer(serializers.ModelSerializer):
    class Meta:
        model  = Grupo
        fields = ['grup_id', 'grup_dsc', 'grup_dat_cria', 'user_dsc', 'grup_dat_atua']
...
class ListaMateriaisPorGrupoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Material
        fields = ['mate_id', 'grup_dsc', 'mate_dsc', 'mate_dat_cria', 'user_dsc', 'mate_dat_atua']

class MaterialSerializer(serializers.ModelSerializer):
    class Meta:
        model  = Material
        fields = ['mate_id', 'grup_id', 'mate_dsc', 'mate_dat_cria', 'user_dsc', 'mate_dat_atua']

class ControleMaterialSerializer(serializers.ModelSerializer):
    class Meta:
        model  = ControleMaterial
        fields = ['mate_id', 'cmat_ind_ativo', 'user_dsc', 'cmat_dat_atua']