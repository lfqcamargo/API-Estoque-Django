...
class Grupo(models.Model):
    ...
    grup_dsc      = models.CharField(max_length=100, null=False, blank=False, db_column='GRUP_DSC', verbose_name='Descrição')
    ...
    user_dsc      = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL, db_column='USER_DSC', verbose_name='Usuário')
